...
\copy Sales.SalesPerson FROM '../AdventureWorks-oltp-install-script/SalesPerson.csv' DELIMITER E'\t' CSV;
...
\copy Sales.Store FROM '../AdventureWorks-oltp-install-script/Store.csv' DELIMITER E'\t' CSV;
